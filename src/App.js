...
const Figures = () => {
  ...
  //         statesStatus = Object.assign(statesStatus, {
  //           [currentState]: {
  //             fill: rtColor
  //           }
  //         })
  ...
  // // Function that assigns a color to a state based on rt value
  // let statesCustomConfig = () => {
  //   let statesStatus = stateColors();
...
const USAMap = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="us-map" preserveAspectRatio="xMinYMin meet" x="0px" y="0px" width="959px" height="593px" viewBox="174 100 959 593" enable-background="new 174 100 959 593">
      <g id="g5">
